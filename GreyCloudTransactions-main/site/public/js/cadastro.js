...
function validar() {
    ...
    var campos = [razaoSocial, cnpj, cep, logradouro, numero, telefone, email, nomeFuncionario, cpfFuncionario, cargoFuncionario, email, senhaFuncionario, confirmarSenha];
...
// -----------------------------------------------------------------------------------------
    if (tamanhoCargoFuncionario > 45) {
        textoAlerta += "O nome do representante deve ter no máximo 75 caracteres.\n";
    }
