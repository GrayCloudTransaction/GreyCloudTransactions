...
CREATE TABLE IF NOT EXISTS `Funcionario` (
  ...
  FOREIGN KEY (`Supervisor`) REFERENCES `Funcionario` (`idFuncionario`),
...
(null,"Gabriel","gabriel@gmail.com","12345","presidente",09348571, null, 10),
(null,"Raphael","raphael@gmail.com","12345","Analísta Junior",09343343, 100, 10),
(null,"Carlos","carlos@gmail.com","12345","Analísta Sênior",09309848, null, 11)
;
